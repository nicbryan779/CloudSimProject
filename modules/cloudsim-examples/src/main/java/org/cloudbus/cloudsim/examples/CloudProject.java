...
public class CloudProject {
	...
	private static Datacenter createDatacenter(String name) {
		...
		// establish the CPU computing speed
		// we need to make 2 PE for each VM (need 2 VMs)
	...
	private static List<Vm> createVM(int id, int num) {
		...
		for(int i=0; i< num ;i++){
			vm[i] = new Vm(i, id, mips, pesNumber, ram, bandwidth, size, vmm, new CloudletSchedulerTimeShared());
	...
	public static void main(String[] args) {
		...
		try {
			...
			cloudletList = createCloudlet(brokerId,88);
